...
export type SettingsSection = 'providers' | 'defaultModel' | 'conversationSettings' | 'roles' | 'general' | 'display' | 'proxy' | 'shortcuts' | 'data' | 'storage' | 'dataStorage' | 'about' | 'searchProviders' | 'mcpServers' | 'agentExecutors' | 'backup';
